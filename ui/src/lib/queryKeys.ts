export const queryKeys = {
  ...
  deployments: {
    list: (companyId: string, projectId: string) =>
      ["deployments", companyId, projectId] as const,
    settings: (companyId: string) => ["deployments", "settings", companyId] as const,
  },
  goals: {
  ...
  github: {
    status: (companyId: string) => ["github", "status", companyId] as const,
    repos: (companyId: string) => ["github", "repos", companyId] as const,
  },
  skills: {
